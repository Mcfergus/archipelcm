...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{asset('assets-admin/css/material-dashboard.min.css?v=2.1.0')}}" rel="stylesheet" />
...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('{{ asset('assets-admin/img/login.jpg') }}');" background-size: cover; background-position: top center;">
 ...
 @yield('scripts')
  ...
  <!-- Sharrre libray -->
  <script src="{{asset('assets-admin/demo/jquery.sharrre.js')}}"></script>
  <script>
    $(document).ready(function() {
